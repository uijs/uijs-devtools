...
module.exports = function(options, callback) {
  ...
  var js     = 'js'     in options ? options.js     : path.join(outdir, 'index.js');
  var html   = 'html'   in options ? options.html   : path.join(outdir, 'index.html');
  ...
  if (path.extname(options.package) === '.js') {
    ...
    js     = 'js'   in options ? options.js : barename + '.uijs.js';
